...
const applyAssociations = () => {
  ...
  // Add missing association between StudentDetails and Extracurricular
  StudentDetails.hasMany(Extracurricular, { foreignKey: "Userid", as: "extracurricular" });
  Extracurricular.belongsTo(StudentDetails, { foreignKey: "Userid", as: "studentDetails" });
...
// StudentDetails - Internship associations
StudentDetails.hasMany(Internship, { foreignKey: "Userid", as: "internships" });
Internship.belongsTo(StudentDetails, { foreignKey: "Userid", as: "studentDetails" });
