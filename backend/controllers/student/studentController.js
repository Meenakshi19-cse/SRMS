...
export const getStudentDetails = async (req, res) => {
    try {
      ...
      if (!student) {
        console.log("No student details found for userId:", userId);
        return res.status(404).json({ message: "Student details not found. Please contact administrator." });
      }
  ...
  export const updateStudentDetails = async (req, res) => {
    ...
    try {
      ...
      if (otherFields.first_graduate === "Yes") {
        otherFields.first_graduate = true;
      } else if (otherFields.first_graduate === "No") {
        otherFields.first_graduate = false;
      }
