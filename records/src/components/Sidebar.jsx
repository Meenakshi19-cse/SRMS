  ...
  const renderSidebarItems = () => {
    switch (role) {
        ...
        return (
          <>
            ...
            <SidebarLink to="/staff-list" icon={<FaUserTie />} label="Staff List" />
                        <SidebarLink to="/staff-activities" icon={<FaUserTie />} label="Staff Activities" />
                        <SidebarLink to="/student-activities" icon={<FaUserTie />} label="Student Activities" />
      ...
      case "Staff":
        return (
          <>
                                  <SidebarLink to="/staffdashboard" icon={<FaUsers />} label="Dashboard" />

            <SidebarLink to="/staff" icon={<FaChalkboardTeacher />} label="Student Dashboard" />
            <SidebarLink to="/myward" icon={<FaUsers />} label="My Ward" />
            <SidebarLink to="/personal" icon={<FaUserGraduate />} label="Personal" />
            <SidebarLink to="/education" icon={<FaBook />} label="Education" />
            <SidebarLink to="/scholars" icon={<FaUsers />} label="Scholars" />
            <SidebarLink to="/proposals" icon={<FaFileUpload />} label="Consultancy" />
            <SidebarLink to="/project-proposal" icon={<FaFileUpload />} label="Funded Project" />
            <SidebarLink to="/seed-money" icon={<FaFileUpload />} label="Seed Money" />
            <SidebarLink to="/events" icon={<FaCalendarAlt />} label="Events Attended" />
            <SidebarLink to="/industry" icon={<FaUserTie />} label="Industry Knowhow" />
            <SidebarLink to="/certifications" icon={<FaCertificate />} label="Certification Courses" />
            <SidebarLink to="/book-chapters" icon={<FaBook />} label="Publications" />
            <SidebarLink to="/events-organized" icon={<FaAward />} label="Events Organized" />
            <SidebarLink to="/h-index" icon={<FaFileUpload />} label="H-Index" />
            <SidebarLink to="/resource-person" icon={<FaUserGraduate />} label="Resource Person" />
            <SidebarLink to="/recognition" icon={<FaAward />} label="Recognition" />
            <SidebarLink to="/patent-product" icon={<FaFileUpload />} label="Patent/Product Development" />
            <SidebarLink to="/project-mentors" icon={<FaUsers />} label="Project Mentors" />
